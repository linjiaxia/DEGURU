<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/www/web/miracle_51zuopin_com/public_html/../application/admin/view/goods/create.html";i:1528948772;s:62:"/www/web/miracle_51zuopin_com/application/admin/view/base.html";i:1528869354;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<div id="tab-system" class="HuiTab">
			...
			<div class="tabCon">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" name="feature">
					</div>
				</div>
				<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="supermarket_price" placeholder="0.00" class="input-text" style="width:90%">
						元</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>本店价：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="shop_price" placeholder="0.00" class="input-text" style="width:90%">
						元</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">赠送积分：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="credit" placeholder="不填，默认和商品价格相同" value="" class="input-text">
						</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">兑换所需要的积分：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="credit_price" placeholder="不填，默认不能使用积分兑换" value="" class="input-text">
						</div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9 skin-minimal">
						<div class="radio-box">
							<input name="is_freight" type="radio" value="1" checked>
							<label>是</label>
						</div>
						<div class="radio-box">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="freight_price" placeholder="0.00" value="" class="input-text freight" disabled style="width:90%">
						元</div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9 skin-minimal">
						<div class="radio-box">
							<input name="is_promote" type="radio" value="0" checked>
							<label>否</label>
						</div>
						<div class="radio-box">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="promote_price" placeholder="0.00" value="" class="input-text promote" disabled style="width:90%">
						元</div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'datemax\')||\'%y-%M-%d\'}' })" id="datemin" name="promote_start_time" class="input-text Wdate promote" style="width:180px;" disabled>
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">促销结束时间：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'datemin\')}' })" id="datemax" name="promote_end_time" class="input-text Wdate promote" style="width:180px;" disabled>
					</div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9 skin-minimal">
						<div class="radio-box">
							<input name="is_hot" type="radio" value="0" checked>
							<label>否</label>
						</div>
						<div class="radio-box">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9 skin-minimal">
						<div class="radio-box">
							<input name="is_new" type="radio" value="0" checked>
							<label>否</label>
						</div>
						<div class="radio-box">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9 skin-minimal">
						<div class="radio-box">
							<input name="is_best" type="radio" value="0" checked>
							<label>否</label>
						</div>
						<div class="radio-box">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9 skin-minimal">
						<div class="radio-box">
							<input name="is_sale" type="radio" value="1" checked>
							<label>上架</label>
						</div>
						<div class="radio-box">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="100" name="sort">
					</div>
				</div>
				<div class="row cl">
			...
			<div class="tabCon">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9"> 
						<script id="editor" name="goods_desc" type="text/plain" style="width:100%;height:400px;"></script> 
					</div>
				</div>
				<div class="row cl">
					<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
			...
			<div class="tabCon">
				...
				<?php if(is_array($level) || $level instanceof \think\Collection || $level instanceof \think\Paginator): $i = 0; $__LIST__ = $level;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><?php echo $v['name']; ?>(<?php echo $v['rate']; ?>)：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="member_price[<?php echo $v['id']; ?>][]" placeholder="0.00" value="" class="input-text" style="width:90%">
						元</div>
				</div>
				<?php endforeach; endif; else: echo "" ;endif; ?>
				<div class="row cl">
			...
			<div class="tabCon">
				...
				<div class="row cl pic">
					<label class="form-label col-xs-4 col-sm-2">
					<a href="javascript:void(0);" onclick="changePic(this)" class="btn btn-primary radius"><i class="Hui-iconfont true">&#xe600;</i></a>
