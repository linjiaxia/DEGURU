<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"/www/web/miracle_51zuopin_com/public_html/../application/admin/view/category/edit.html";i:1528869366;s:62:"/www/web/miracle_51zuopin_com/application/admin/view/base.html";i:1528869354;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="pid" class="select">
					...
					<?php echo $v['id']==$result['pid']?'selected="selected"':''; ?>
