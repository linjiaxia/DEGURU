<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/www/web/miracle_51zuopin_com/public_html/../application/admin/view/privilege/create.html";i:1528869379;s:62:"/www/web/miracle_51zuopin_com/application/admin/view/base.html";i:1528869354;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<div id="tab-category" class="HuiTab">
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3">
					控制器：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="" name="controller">
				</div>
				<div class="col-3">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3">
					方法：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="" name="action">
				</div>
				<div class="col-3">
				</div>
			</div>
