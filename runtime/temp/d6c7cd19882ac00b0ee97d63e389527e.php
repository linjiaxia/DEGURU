<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpStudy\PHPTutorial\WWW\shop\public/../application/index\view\member\index.html";i:1528598660;s:68:"D:\phpStudy\PHPTutorial\WWW\shop\application\index\view\_middle.html";i:1528522359;}*/ ?>
<!DOCTYPE html>
<html>
			...
			<div class="box">
				<div class="user_list">
					...
					<dl>
						...
						<dd><a href="<?php echo url('@address'); ?>">收货地址</a></dd>
					</dl>
					<dl>
				...
				<div class="user_info">
					...
					<ul>
						<li>
							...
							<a href="javascript:void(0)">已完成  8</a>
						</li>
						<li>
							<span>
								<a href="<?php echo url('@cart'); ?>"><img src="/static/img/user_unpay_icon.png" /></a>
							</span>
							<a href="<?php echo url('@cart'); ?>">待付款  <?php echo $memberData['cart_len']; ?></a>
						</li>
						<li>
							<span>
								<a href="javascript:void(0)"><img src="/static/img/user_transfer_icon.png" /></a>
							</span>
							<a href="javascript:void(0)">待收货  1</a>
						</li>
						<li>
							<span>
								<a href="javascript:void(0)"><img src="/static/img/user_comment_icon.png" /></a>
							</span>
							<a href="javascript:void(0)">待评价  5</a>
						</li>
					</ul>
				</div>
