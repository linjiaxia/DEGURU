<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/www/web/miracle_51zuopin_com/public_html/../application/admin/view/water/edit.html";i:1528869383;s:62:"/www/web/miracle_51zuopin_com/application/admin/view/base.html";i:1528869354;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<form class="form form-horizontal" id="form" enctype="multipart/form-data">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<img width="100" class="product-thumb" src="<?php echo $result['sm_water_img']; ?>" alt="">
			</div>
		</div>	
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="btn-upload form-group">
				...
				<input type="file" multiple name="water_img" class="input-file">
				</span> </div>
		</div>
		<div class="row cl">
