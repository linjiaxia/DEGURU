<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/www/web/miracle_51zuopin_com/public_html/../application/index/view/goods/index.html";i:1528882441;s:65:"/www/web/miracle_51zuopin_com/application/index/view/_middle.html";i:1528904101;}*/ ?>
<!DOCTYPE html>
<html>
				...
				<ul>
					<li>
						...
						<ul>
							...
							<li><a href="javascript:void(0)" brand_id="<?php echo $v['id']; ?>"><?php echo $v['english']!=''?$v['english'].'/' : ''; ?><?php echo $v['name']; ?></a></li>
					...
					<li>
						...
						<ul>
							...
							<li><a href="javascript:void(0)" attr_id="<?php echo $vo; ?>"><?php echo $vo; ?></a></li>
							<?php endforeach; endif; else: echo "" ;endif; ?>
						</ul>
					</li>
					<?php endforeach; endif; else: echo "" ;endif; ?>
