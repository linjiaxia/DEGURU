<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"/www/web/miracle_51zuopin_com/public_html/public/../application/index/view/index/index.html";i:1528730989;s:74:"/www/web/miracle_51zuopin_com/public_html/application/index/view/_nav.html";i:1528730962;}*/ ?>
<!DOCTYPE html>
<html>
		...
		<div class="middle">
			...
			<div class="hot_cake_pro">
				...
				<div class="sales_best">
					...
					<ul>
						<li>
							<a href="<?php echo url('@detail/'.$v['id']); ?>"><img src="/public/static/img/sales_best_pro_1.jpg" alt="" /></a>
							<div>
								<h5><a href="<?php echo url('@detail/'.$v['id']); ?>">电炖锅煲汤锅白瓷陶瓷隔水全自动炖汤煮粥</a></h5>
								<span>月销量5572</span>
						...
						<li>
							<div>
								<h5><a href="pro_details.html">智能电炖盅/电炖锅</a></h5>
							</div>
							<a href="pro_details.html"><img src="/public/static/img/sales_best_pro_2.jpg" alt="" /></a>
						</li>
					</ul>
				</div>
				<div class="evaluate_best">
					...
					<ul>
						<li>
							<a href="pro_details.html"><img src="/public/static/img/sales_best_pro_1.jpg" alt="" /></a>
							<div>
								<h5><a href="pro_details.html">电炖锅煲汤锅白瓷陶瓷隔水全自动炖汤煮粥</a></h5>
								<span>月销量5572</span>
								<p class="price">￥199.0</p>
							</div>
						</li>
						...
						<li>
							...
							<a href="pro_details.html"><img src="/public/static/img/evaluate_best_pro_3.jpg" alt="" /></a>
						</li>
						<li>
							<a href="pro_details.html"><img src="/public/static/img/sales_best_pro_4.jpg" alt="" /></a>
							<div>
								<h5><a href="pro_details.html">电炖锅煲汤锅白瓷陶瓷隔水全自动炖汤煮粥</a></h5>
								<span>月销量5572</span>
								<p class="price">￥199.0</p>
...
<!--尾部-->
	...
	<script type="text/javascript" src="/public/static/js/bannerLeft.js"></script>
