<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/www/web/miracle_51zuopin_com/public_html/../application/admin/view/brand/create.html";i:1528869365;s:62:"/www/web/miracle_51zuopin_com/application/admin/view/base.html";i:1528869354;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<form class="form form-horizontal" id="form" enctype="multipart/form-data">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" name="english">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" name="url">
			</div>
		</div>
		<div class="row cl">
