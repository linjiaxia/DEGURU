<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/www/web/miracle_51zuopin_com/public_html/../application/admin/view/member/index.html";i:1528869375;s:62:"/www/web/miracle_51zuopin_com/application/admin/view/base.html";i:1528869354;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="recycles()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量移除</a> </span> <span class="r">共有数据：<strong><?php echo $total; ?></strong> 条</span> </div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td class="td-status"><span class="label <?php echo $v['status']==1?'label-primary':'label-error'; ?> radius"><?php echo $v['status']==1?'已激活':'未激活'; ?></span></td>
				<td><?php echo date('Y-m-d H:i:s',$v['create_time']); ?></td>
				<td class="td-manage"><a style="text-decoration:none" onclick="show('会员查看','<?php echo url('detail',['id'=>$v['id']]); ?>','','350')" href="javascript:;" title="会员查看"><i class="Hui-iconfont">&#xe637;</i></a> <a style="text-decoration:none" class="ml-5" onclick="recycle('<?php echo $v['id']; ?>')" href="javascript:;" title="会员移除"><i class="Hui-iconfont">&#xe6de;</i></a></td>
			</tr>
