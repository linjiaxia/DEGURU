<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/www/web/miracle_51zuopin_com/public_html/../application/index/view/cart/index.html";i:1528888603;s:62:"/www/web/miracle_51zuopin_com/application/index/view/_nav.html";i:1528904100;}*/ ?>
<!DOCTYPE html>
<html>
				...
				<table cellpadding="0" cellspacing="0" border="0">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="<?php echo url('@detail/' . $v['goods_id']); ?>"><img src="<?php echo $v['sm_logo']; ?>" alt="<?php echo $v['name']; ?>"  style="width: 191px;height: 92px;"></a><h4><a href="<?php echo url('@detail/' . $v['goods_id']); ?>"><?php echo $v['name']; ?></a></h4>
							...
							<td style="display: none;"><input id="goods_id" name="goods_id[<?php echo $v['id']; ?>]" value="<?php echo $v['goods_id']; ?>" /></td>
